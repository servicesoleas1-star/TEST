...
// En-tête/pied de page communs (SiteHeader/Footer) — le bouton WhatsApp
// flottant est déjà rendu globalement par App.jsx sur toutes les pages.
// ---------------------------------------------------------------------------
...
export default function ContactPage() {
  ...
  const { supportWhatsAppNumber: WHATSAPP_NUMBER } = usePlatformConfig();
